var proportion = .8; // kırpılan görüntünün oranını değiştirebilirsiniz.
var theImage = "https://avatars.githubusercontent.com/u/54273323?v=4";
var output = document.getElementById("output");
var c1 = document.getElementById("c1");
var ctx1 = c1.getContext("2d");
var c2 = document.getElementById("c2");
var ctx2 = c2.getContext("2d");
var cw = c1.width = c2.width = 400,cx = cw / 2;
var ch = c1.height = c2.height = 400,cy = ch / 2;
...
var o = { // kırmak için kullanılan çubuklar özeleştirmek;
  "sx": {
    color: "red",
    x: 0,
    y: sy,
...
function Imgo(o, d) { // kırpılan resmi gösternmeka adına
  var imgo = {
    sx: o.sy.x,
    sy: o.sx.y,
    sw: o.sh.x - o.sy.x,
...
function Output(Imgo, output) {
  output.innerHTML = "img eksen çubuk ve krpma kordinatı = " + imgo.sx + "," + imgo.sy + "," + imgo.sw + "," + imgo.sh + "," + imgo.x + "," + imgo.y + "," + imgo.w + "," + imgo.h + ")";
}
